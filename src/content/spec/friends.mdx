...
export const site = {
  name: "倪东林的个人博客",
  desc: "记录个人学习、生活、工作中的点点滴滴。",
  url: "https://nidonglin.com",
  avatar: "https://nidonglin.com/assets/images/avatar.avif",
};
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">在下方评论区留言申请</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">按下面的模板填写，复制修改后发在评论区</p>
